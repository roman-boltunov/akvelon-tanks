...
namespace Prototype.NetworkLobby
{
    public class LobbyManager : NetworkLobbyManager
    {
        ...
        private NetworkConnection _standLobbyConnection;
        ...
        void Start()
        {
            ...
            // client ping to save connection
            NetworkServer.RegisterHandler(MsgType.Highest + 100, (NetworkMessage netMsg) => {
                _standLobbyConnection = netMsg.conn;
            });

            // start game
            NetworkServer.RegisterHandler(MsgType.Highest + 101, (NetworkMessage netMsg) => {
                ...
                // TODO when we have a client connected (lobby) OnLobbyServerPlayersReady is not called
